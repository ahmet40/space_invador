...
public class Executable extends Application {
    ...
    /**
     * Pemert de renvoyer la stage sur laquelle nous nous trouvons.
     * @return la stage 
     */
    ...
    /**
     * permet de cree la scene de l'accueil qui va contenir une image, texte, bouton
     * @return la scene que l'on à crée
     */
    public Scene Acceuil(){
            ...
            File file = new File("./img/Space.png");
            //Image image = new Image(file.toURI().toString());
            Image img=new Image(file.toURI().toString(),gestionnaire.getLargeur()+300,gestionnaire.getHauteur()+300,true,true);         // on crée l'image que l'on veut mettre
     ...
     */
         ...
         * @return renvoie la nouvelle scene
         */
        public Scene fin(Stage stage,String ch){
            ...
            this.vbox.setPadding(new Insets((gestionnaire.getHauteur()*10)/2-70,(gestionnaire.getLargeur()*10)/2+30,(gestionnaire.getHauteur()*10)/2-70,((gestionnaire.getLargeur()*10)/2)/2-140));
            root.getChildren().add(vbox);
            File file = new File("./img/Space.png");
            Image img=new Image(file.toURI().toString(),gestionnaire.getLargeur()+300,gestionnaire.getHauteur()+300,true,true);         // on crée l'image que l'on veut mettre
            root.setBackground(new Background(new BackgroundImage(img,BackgroundRepeat.REPEAT,BackgroundRepeat.REPEAT,BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT)));
