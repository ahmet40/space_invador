 ...
 */
 ...
 public class ProjectileAlienTypeDeux extends Projectile{
     ...
     */
    public ProjectileAlienTypeDeux(double x,double y){
        super(x,y);
        this.evoluer=0.3;
    }
    @Override 
    ...
    public EnsembleChaines getEnsembleChaines(){
        ...
        for (ChainePositionnee c:ch.getChaines()){c.setIsRouge(true);}
        // grâce au changement de l'attribut setIsRouge sur cette chaine, on va pouvoir mettre la couleur blanche à ce projectile. 
        return ch;
    };
